...
#'                            start.state = 1)
#'
sim_multiple_cancer_indiv <- function(ID, cancer_sites, rate_matrices, early_sensitivities, late_sensitivities, specificities, obs.times = seq(1, 30, 2), end.time = 30, start.time = 0, start.state = 1) {
...
#'                                           start.state = 1)
#'
sim_multiple_cancer_multiple_individuals <- function(num_individuals, cancer_sites, rate_matrices, early_sensitivities,
                                                     late_sensitivities, specificities, obs.times = seq(1, 30, 2), end.time = 30,
